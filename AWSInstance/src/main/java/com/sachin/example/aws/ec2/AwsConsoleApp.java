...
//            credentials = new ProfileCredentialsProvider().getCredentials();
            credentials = login.getAWSCredentials();
        } catch (Exception e) {
        ...
        ec2 = new AmazonEC2Client(credentials, login.getProxyPass());
        s3  = new AmazonS3Client(credentials, login.getProxyPass());
        sdb = new AmazonSimpleDBClient(credentials, login.getProxyPass());
    }
